...
class hello : public ::google::protobuf::Message {
 ...
 private:
  ...
  ::std::string* data_;
  static ::std::string* _default_data_;
...
// required string data = 1 [default = "Hello World!"];
inline bool hello::has_data() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void hello::set_has_data() {
  _has_bits_[0] |= 0x00000001u;
}
inline void hello::clear_has_data() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void hello::clear_data() {
  if (data_ != _default_data_) {
    data_->assign(*_default_data_);
  }
  clear_has_data();
}
...
inline ::std::string* hello::mutable_data() {
  set_has_data();
  if (data_ == _default_data_) {
    data_ = new ::std::string(*_default_data_);
  }
  return data_;
}
