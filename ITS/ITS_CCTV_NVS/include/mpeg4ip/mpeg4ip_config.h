/* mpeg4ip_config.h.in.  Generated from configure.ac by autoheader.  */
...
/* Define to 1 if `time_base' is a member of `AVCodecContext'. */
...
/* Define to 1 if `rc.i_rc_method' is a member of `x264_param_t'. */
